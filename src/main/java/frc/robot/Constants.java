...
public final class Constants {
  public static class OperatorConstants {
    public static final int XboxControllerDrive = 0;
    public static final int XboxControllerFunctions = 1;
  }

  public static class Motors {
    public static final com.ctre.phoenix6.hardware.Pigeon2 PIGEON2  = new Pigeon2 (0);
  }
